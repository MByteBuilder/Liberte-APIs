                                    ...
                                    <div class="card-body">
                                        <div class="tbleSearch">
                                            ...
                                            <div class="right">
                                                ...
                                                <div class="search">
                                                    <input class="form-control" type="text" id="search_text" placeholder="Search" onkeyup="search()">
                                        ...
                                        <tr>
                                            ...
                                            <?php //echo substr($list->message,0,20)."...";?>
                                                <?php echo $list->wallet_id;?>
                                            </td>
                                            <td>
                                            <?php //echo substr($list->message,0,20)."...";?>
                                                <?php echo $list->wallet_point;?>
                                            </td>
                                            <td>
   ...
   function pagination(key_id){
      ...
      let last_row = $("#last_row_"+key_id).val();
          ...
          let APIData = {"lastrow":last_row,"page_no":key_id};
            $.ajax({
            url: "<?php echo BASEPATH ?>api/v1/usertable-list",
            type: "get",
            data: APIData,
            success : function(data){
              console.log(data);
