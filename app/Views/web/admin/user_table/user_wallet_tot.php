                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            $x=1;
                                            foreach($user_wallet_data as $list){ 
                                            ?>
                                        <tr>
                                            <td>
                                                <?php echo $x++;?>
                                            ...
                                            <?php if(!empty($user_data[0]->wallet_id)){?>
                                            <td>
                                                <?php echo $user_data[0]->wallet_id;?>
                                            </td> 
                                            <?php }?>

                                            <td>
                                                <?php if($list->type == 1){echo "<p style='color:green'>credited</p>";}else{echo "<p style='color:red'>Drevited</p>";}?>
                                            </td> 
   ...
   function pagination(key_id){
    ...
    //alert(wallet_id);
          ...
          let APIData = {"lastrow":last_row,"page_no":key_id,"id":id};
            $.ajax({
            url: "<?php echo BASEPATH ?>api/v1/user-wallet-details",
            type: "get",
            data: APIData,
            success : function(data){
              console.log(data);
              ...
              $.each(data.data, function(index, value) {
                ...
                let htmlbody = '';
                  htmlbody += '<tr>';
                  htmlbody += '<td>'+sl+'</td>';
                  htmlbody += '<td>'+wallet_id+'</td>';
                if(value.type == 1){
                  htmlbody += '<td><p style="color:green;">Credited</p></td>';
                }else{
                  htmlbody += '<td><p style="color:green;">Drevited</p></td>';
                }
                  htmlbody += '<td>'+value.points+'</td>';
                  htmlbody += '<td>'+value.added_on+'</td>';
