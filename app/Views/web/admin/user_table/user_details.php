                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">User Details :: <?php echo $user_data[0]->name;?></h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo BASEPATH;?>console/usertable">User list</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6" >
                                <!-- card -->
                                <a href ="<?php echo BASEPATH;?>console/user-details?id=<?php  if(!empty($user_data[0])){ echo $user_data[0]->id;}?>">
                                <div class="card card-h-100" style="background-color:#F3D8D3;">
                                   
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate"> <?php  if(!empty($user_data[0]->gender)){ if($user_data[0]->gender ==1){ echo '<i class="fa fa-male" aria-hidden="true"></i>';}else{ echo'<i class="fa fa-female" aria-hidden="true"></i>';} }?>  </span>
                                                <h6 class="mb-3">
                                                Profile
                                            ...
                                            <span class="ms-1 text-muted font-size-10"></span>
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <!-- card -->
                                <a href ="<?php echo BASEPATH;?>console/user-wallet-page?id=<?php  if(!empty($user_data[0])){ echo $user_data[0]->id;}?>">
                                <div class="card card-h-100" style="background-color:#F3D8D3;">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate"><i class="fa fa-credit-card" aria-hidden="true"></i> </span>
                                                <h6 class="mb-3">
                                                    Wallet
                                                </h6>
                                        ...
                                        <div class="text-nowrap">
                                            <?php //if(!empty($user_wallet_data[0])){ if($user_wallet_data[0]->type ==1){?>
                                                <!-- <span class="badge bg-soft-danger text-success"> Credit </span> -->
                                            <?php //}else{?>
                                                <!-- <span class="badge bg-soft-danger text-danger"> Debit </span> -->
                                            <?php //} }?>
                                            <span class="ms-1 text-muted font-size-13"><?php //if(!empty($user_wallet_data[0])){ $in = $user_wallet_data[0]->details; echo $out = strlen($in) > 15 ? substr($in,0,15)."..." : $in;}else{echo"No points Details";}?></span>
                                        </div>
                                    </div>
                                </div>
                                </a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <!-- card -->
                                <a href ="<?php echo BASEPATH;?>console/user-walking-page?id=<?php  if(!empty($user_data[0])){ echo $user_data[0]->id;}?>">
                                <div class="card card-h-100" style="background-color:#F3D8D3;">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                ...
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate"><img src="https://cdn-icons-png.flaticon.com/512/6591/6591691.png" style="width:20px;"></span>
                                                <h6 class="mb-3">
                                                    Walk & Earn
                                                </h6>
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                ...
                                <div class="card card-h-100" style="background-color:#F3D8D3;">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <span class="text-muted mb-3 lh-1 d-block text-truncate">  Drink Activity </span>
                                                <h4 class="mb-3">
