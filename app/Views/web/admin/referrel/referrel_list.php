                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Referrel List</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Referrel</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody id="top_search_list">
                                                <?php
                                            if(!empty($referrel_code_list)){
                                            $x=1;
                                            foreach($referrel_code_list as $key=>$list){ 
                                            ?>
                                        <tr>
                                            <td>
                                                <?php echo $x++;?>
                                            ...
                                            <td>
                                                <?php echo $list->team_member_name;?>
                                            </td> 
                                            <!-- <td>
                                                <?php //echo $list->team_member_email;?>
                                            </td>  -->

                                            <!-- <td>
                                               
                                                <?php //echo $list->team_member_phone;?>
                                            </td>  -->
                                            <td>
...
<script>
   function pagination(key_id){
      ...
      // let sl = $("#sl_no").val();
          ...
          let APIData = {"lastrow":last_row,"page_no":key_id,"user_id":user_id,"user_type":user_type};
            $.ajax({
            url: "<?php echo BASEPATH ?>api/v1/referrel-code-list",
            type: "get",
            data: APIData,
            success : function(data){
              console.log(data);
